...
# 3.6
    ...
    class _ConcatenablueiasMeta(typing.TypingMeta):
        """Metaclass for Concatenate."""

        def __repr__(self):
            return 'typing_extensions.Concatenate'

    class _ConcatenablueiasBase(typing._FinalTypingBase,
                                metaclass=_ConcatenablueiasMeta,
                                _root=True):
        """Used in conjunction with ``ParamSpec`` and ``Callable`` to represent a
        higher order function which adds, removes or transforms parameters of a
        callable.
    ...
    Concatenate = _ConcatenablueiasBase(_root=True)
